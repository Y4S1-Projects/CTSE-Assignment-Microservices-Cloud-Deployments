...
import { createOrder, getMenuItems, getMyOrders, processPayment } from "@/lib/foodService";
import {
	clearCart,
	getAuthToken,
	getCart,
...
export default function CustomerPage() {
	...
	async function handleCheckout() {
		...
		try {
			...
			await processPayment(orderId, totalAmount);

			const completedOrder = {
				id: orderId,
				userId: created?.userId || profile?.id,
				totalAmount,
			...
			clearCart();
			setCart([]);
			setSuccess("Order placed and payment processed successfully.");
		} catch (checkoutError) {
